...
def create_circles():
    ...
    #shift_up = 180
    shift_up=0
    main_circle = AppCircle((center_x, center_y-shift_up), main_circle_radius, 0, (center_x, center_y), is_main=True)
    ...
    for i in range(num_circles):
        ...
        y = center_y + int(distance * math.sin(angle))-shift_up
        circles.append(AppCircle((center_x, center_y-shift_up), app_circle_radius, i + 1, (x, y)))
    return circles
